...
/**
 * "FruitsFragment" listing
 */
public class FruitsFragment extends ListGridFragment<DatacsvDSSchemaItem>  {

    private Datasource<DatacsvDSSchemaItem> datasource;


    public static FruitsFragment newInstance(Bundle args) {
        FruitsFragment fr = new FruitsFragment();
    ...
    protected SearchOptions getSearchOptions() {
      SearchOptions.Builder searchOptionsBuilder = SearchOptions.Builder.searchOptions();
            searchOptionsBuilder
                    .withFixedFilters(Arrays.<Filter>asList(new StringFilter("category", "Fruits")));
    ...
    */
    ...
    public void showDetail(DatacsvDSSchemaItem item, int position) {
        ...
        Intent intent = new Intent(getActivity(), FruitsDetailActivity.class);
