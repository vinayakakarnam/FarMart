...
public class VegetablesMenuItem2DetailFragment extends ibmmobileappbuilder.ui.DetailFragment<DatacsvDSSchemaItem> implements ShareBehavior.ShareListener  {

    private Datasource<DatacsvDSSchemaItem> datasource;
    public static VegetablesMenuItem2DetailFragment newInstance(Bundle args){
        VegetablesMenuItem2DetailFragment fr = new VegetablesMenuItem2DetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public VegetablesMenuItem2DetailFragment(){
        super();
    }
    ...
    protected int getLayout() {
        return R.layout.vegetablesmenuitem2detail_detail;
    }
