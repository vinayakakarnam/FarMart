...
/**
 * "VegetablesMenuItem2Fragment" listing
 */
public class VegetablesMenuItem2Fragment extends ListGridFragment<DatacsvDSSchemaItem>  {

    private Datasource<DatacsvDSSchemaItem> datasource;


    public static VegetablesMenuItem2Fragment newInstance(Bundle args) {
        VegetablesMenuItem2Fragment fr = new VegetablesMenuItem2Fragment();
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.vegetablesmenuitem2_item;
    }
    ...
    public void showDetail(DatacsvDSSchemaItem item, int position) {
        ...
        Intent intent = new Intent(getActivity(), VegetablesMenuItem2DetailActivity.class);
