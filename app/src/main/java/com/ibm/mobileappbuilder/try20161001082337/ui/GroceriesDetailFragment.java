...
public class GroceriesDetailFragment extends ibmmobileappbuilder.ui.DetailFragment<DatacsvDSSchemaItem> implements ShareBehavior.ShareListener  {

    private Datasource<DatacsvDSSchemaItem> datasource;
    public static GroceriesDetailFragment newInstance(Bundle args){
        GroceriesDetailFragment fr = new GroceriesDetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public GroceriesDetailFragment(){
        super();
    }
    ...
    protected int getLayout() {
        return R.layout.groceriesdetail_detail;
    }
