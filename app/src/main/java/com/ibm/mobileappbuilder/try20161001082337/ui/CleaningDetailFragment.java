...
public class CleaningDetailFragment extends ibmmobileappbuilder.ui.DetailFragment<DatacsvDSSchemaItem> implements ShareBehavior.ShareListener  {

    private Datasource<DatacsvDSSchemaItem> datasource;
    public static CleaningDetailFragment newInstance(Bundle args){
        CleaningDetailFragment fr = new CleaningDetailFragment();
    ...
    protected int getLayout() {
        return R.layout.cleaningdetail_detail;
    }
