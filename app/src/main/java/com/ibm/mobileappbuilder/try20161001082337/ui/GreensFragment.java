...
/**
 * "GreensFragment" listing
 */
public class GreensFragment extends ListGridFragment<DatacsvDSSchemaItem>  {

    private Datasource<DatacsvDSSchemaItem> datasource;


    public static GreensFragment newInstance(Bundle args) {
        GreensFragment fr = new GreensFragment();
    ...
    protected SearchOptions getSearchOptions() {
      SearchOptions.Builder searchOptionsBuilder = SearchOptions.Builder.searchOptions();
            searchOptionsBuilder
                    .withFixedFilters(Arrays.<Filter>asList(new StringFilter("category", "Greens")));
    ...
    */
    ...
    public void showDetail(DatacsvDSSchemaItem item, int position) {
        ...
        Intent intent = new Intent(getActivity(), GreensDetailActivity.class);
