...
/**
 * "GroceriesFragment" listing
 */
public class GroceriesFragment extends ListGridFragment<DatacsvDSSchemaItem>  {

    private Datasource<DatacsvDSSchemaItem> datasource;


    public static GroceriesFragment newInstance(Bundle args) {
        GroceriesFragment fr = new GroceriesFragment();
    ...
    protected SearchOptions getSearchOptions() {
      SearchOptions.Builder searchOptionsBuilder = SearchOptions.Builder.searchOptions();
            searchOptionsBuilder
                    .withFixedFilters(Arrays.<Filter>asList(new StringFilter("category", "Groceries")));
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.groceries_item;
    }
    ...
    public void showDetail(DatacsvDSSchemaItem item, int position) {
        ...
        Intent intent = new Intent(getActivity(), GroceriesDetailActivity.class);
